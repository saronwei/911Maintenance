(function (B, p) {
    var r = function (a) {
        ...
        createLambda: function (a) {
            ...
            if ("string" === typeof a) {
                ...
                } else b = a.match(/^[(\s]*([^()]*?)[)\s]*=>(.*)/), b = new Function(b[1],
                    "return " + b[2]);
                return A[a] = b
            }
            return a
    ...
    d.Utils.createEnumerator = function (a,
                                         b, c) {
        return new g(a, b, c)
    };
        ...
        return new d(function () {
            ...
            return new g(function () {
                ...
                if (n) {
                    ...
                    if (d.moveNext())return this.yieldReturn(l =
                        d.current())
                }
    ...
    d.prototype.buffer = function (a) {
        ...
        return new d(function () {
            ...
            return new g(function () {
                ...
                for (var b =
                    [], d = 0; c.moveNext();)if (b.push(c.current()), ++d >= a)return this.yieldReturn(b);
    ...
    d.prototype.firstOrDefault = function (a, b) {
        b === p && (b = null);
        if (null != a)return this.where(a).firstOrDefault(null, b);
        var c, d = !1;
        this.forEach(function (a) {
            c = a;
            d = !0;
    ...
    d.prototype.lastOrDefault = function (a, b) {
        b === p && (b = null);
        if (null != a)return this.where(a).lastOrDefault(null, b);
        var c, d = !1;
        this.forEach(function (a) {
            d = !0;
            c = a
    ...
    m.prototype.count = function (a) {
        return null == a ? this.getSource().length : d.prototype.count.apply(this,
            arguments)
    };
    ...
    m.prototype.firstOrDefault = function (a, b) {
        b === p && (b = null);
        if (null != a)return d.prototype.firstOrDefault.apply(this, arguments);
        var c = this.getSource();
    ...
    m.prototype.lastOrDefault = function (a, b) {
        b === p && (b = null);
        if (null != a)return d.prototype.lastOrDefault.apply(this, arguments);
        var c = this.getSource();
    ...
    m.prototype.sequenceEqual = function (a, b) {
        return (a instanceof m || a instanceof Array) && null == b && d.from(a).count() !=
        this.count() ? !1 : d.prototype.sequenceEqual.apply(this, arguments)
    };
    ...
    t.prototype.getEnumerator = function () {
        var a =
            this.prevPredicate, b = this.prevSelector, c = this.prevSource, d;
        return new g(function () {
            d = c.getEnumerator()
        }, function () {
