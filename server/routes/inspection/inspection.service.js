...
function InspectionService() {
    ...
    function paramsCheck(params) {
        ...
        var centerVerify = require('../../../resources/verification_collection/inspection.center.verify')();
        var groupVerify = require('../../../resources/verification_collection/inspection.groupName.verify')();
